...
df <- read.csv("C:/github/P3K-HB_Pottery-Kiln/Data/Num_Of_DOKiln.csv")
df <- na.omit(df)
xx <- c(0, 1, 2, 3, 4, 5, 6)
yy <- c(16, 3, 5, 0, 1, 0, 3)
...
ggsave("C:/github/P3K-HB_Pottery-Kiln/Graph/Fig_13.png", dpi=150, width=3.5, height=3.5, units='in')
