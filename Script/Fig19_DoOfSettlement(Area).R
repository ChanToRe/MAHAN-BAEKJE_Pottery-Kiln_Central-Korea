...
ggsave(here("./Graph/Fig_19-1.png"), dpi=150, width=3, height=6, units='in')
...
ggplot(B_pie, aes(x=Type, y=percent, fill=Type)) +
  ...
  theme(axis.line = element_blank(),
        ...
        legend.position = "none",
        axis.text = element_text(size=18, colour="black"))
ggsave(here("./Graph/Fig_19-2.png"), dpi=150, width=3, height=6, units='in')
...
ggplot(C_pie, aes(x=Type, y=percent, fill=Type)) +
  ...
  theme(axis.line = element_blank(),
        ...
        legend.position = "none",
        axis.text = element_text(size=18, colour="black"))
ggsave(here("./Graph/Fig_19-3.png"), dpi=150, width=3, height=6, units='in')
...
ggplot(D_pie, aes(x=Type, y=percent, fill=Type)) +
  ...
  theme(axis.line = element_blank(),
        ...
        legend.position = "none",
        axis.text = element_text(size=18, colour="black"))
ggsave(here("./Graph/Fig_19-4.png"), dpi=150, width=3, height=6, units='in')
...
ggplot(E_pie, aes(x=Type, y=percent, fill=Type)) +
  ...
  theme(axis.line = element_blank(),
        ...
        legend.position = "none",
        axis.text = element_text(size=18, colour="black"))
ggsave(here("/Graph/Fig_19-5.png"), dpi=200, width=3, height=6, units='in')
